...
function callClaude({ payload, modif, history }) {
  ...
  if (modif) {
    ...
    const system = [
      ...
      'NOMENCLATURE DES LOTS (exemples) :',
      '- Lot PLOMBERIE : chauffe-eau, ballon thermodynamique, alimentation eau froide/chaude, évacuations. Ne pas inclure la VMC.',
      '- Lot VENTILATION : VMC simple flux, VMC double flux (l\'échangeur est inhérent à la VMC double flux, ne pas le mentionner séparément).',
      '- Lot MENUISERIES EXTÉRIEURES : fenêtres, portes-fenêtres, fenêtres de toit type Velux.',
      '- Lot MENUISERIES INTÉRIEURES : habillage intérieur des fenêtres de toit, portes intérieures, placards.',
      '- Lot CARRELAGE / FAÏENCE : carrelage sol et mur, douche à l\'italienne (pas "bac douche à l\'italienne").',
      '- Lot REVÊTEMENTS DE SOL : sol PVC / LVT / vinyle (dalles ou lames), parquet.',
      '- Lot NETTOYAGE : évacuation des déchets de chantier.',
      'Ne jamais mélanger plusieurs métiers dans un même lot.',
